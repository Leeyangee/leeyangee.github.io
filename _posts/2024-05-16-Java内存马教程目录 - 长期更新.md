...
wrapper.allocate() 中到底有什么笔者不细写了，反正最后返回的是 StandardWrapper.instance，即一个 Servlet 类型的实例，其数据结构如下所示
...
那到底这个 instance 从何而来呢？我们细细探究发现，instance 被初始化于 StandardWrapper.loadServlet ，如下所示
    ...
    public synchronized Servlet loadServlet() throws ServletException {
        ...
        //若 instance 还未初始化
            ...
            try {
                ...
                //获取 StandardContext.instanceManager
                ...
                //调用 servlet.init(this.farcade)，初始化 servletConfig
