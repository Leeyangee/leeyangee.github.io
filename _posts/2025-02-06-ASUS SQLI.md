...
After boot the kernel, attach the virtual machine before run httpd. then, modify the root to the firmware root that you uploaded, and input following command in your pwndbg
...
Once you started the httpd by inputing the cmd `httpd`, here is a break in func main. input following command in your pwndbg
...
When you run `set $pc=0x16a64`, the values ​​of the r0-r4 registers and the pc register and their corresponding values ​​should be as follows

![asus](/image/asus_sql/14.png)  
